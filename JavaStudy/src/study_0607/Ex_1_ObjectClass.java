...
Object 클래스
모든 클래스의 최상위 (부모) 클래스
선언할 필요 없이 모든 클래스에 강제 상속 되어있다. 
 */

public class Ex_1_ObjectClass {

/*
 매개변수로 Object 변수를 받는다. Object는 모든 객체 변수를 받는다는 뜻으로 어떤 타입의 객체가 올지 모르겠다면 변수 타입을 Object라고 해놓으면 해결 가능하다.
 단, 내부에서 활용할 때는 객체 형변환이 필요할 것이다.
 */
	public static void print(Object obj) {
				//클래스 이름, 패키지명.객체의 클래스명 이런 식으로 되어있다.
