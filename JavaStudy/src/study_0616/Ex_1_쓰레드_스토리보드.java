		...
		public class Ex_1_쓰레드_스토리보드 implements Runnable {
		    private int horse_num;

		    public Ex_1_쓰레드_스토리보드(int horse_num) {
		...
		}// sleepTime/1000 초 만큼 스레드 정지 // 모든 예외 발생 시 순차적으로 추적
		
		/*
		스토리보드란 ?
		1. UX 구현에 수반되는 사용자의 목표, 인터페이스 간 상호작용을 시각화 하여 개발자, 디자이너와의 의사소통을 돕는 도구
