...
<body>
	...
	<div class="jumbotron">
		...
		<!-- container : 스크린의 구획(영역)을 조절하기 위한 클래스 자바에서 JFrame 안에 JPanel을 담는 거랑 유사함 -->
		<div class="container">
			<h1 class="display-6">
	...
	<div class="container">
		<div>
			...
			<!-- 현재 접속 시각을 출력하는 코드  -->
			<%
			response.setIntHeader("Refresh", 5); //5초에 한번 새로고침
			...
			if (hour / 12 == 0) { //현재 시간이 12시 이하이면 오전
				...
				am_pm = "PM";
				hour -= 12; //24시간 형식이기 때문에 12시간을 빼서 12시간 형식으로 바꿈
			} 
			//날짜 출력 부분 ↓ 이 부분에 시간 표시 (문자열 합치기)
			String CT = hour + ":" + minute + ":" + second + " " + am_pm;
			out.println("현재 접속 시각: " + CT + "\n"); //위 내용 출력
			%>
		</div><hr>
	</div>
	<!-- 아랫 부분에 footer.jsp 의 body태그 내용 표현  / include : 외부 파일을 현재 jsp 페이지에 포함 -->
