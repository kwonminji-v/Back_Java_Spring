...
//	상황에 따라 간편하게 적용해서 쓸 수있는 것을 정리하여 특정한 "규약"을 통해 쉽게 쓸 수 있는 형태로 만든 것을 말한다.
//	MVC는 Model, View, Controller 약자이다.
//	하나의 애플리케이션, 프로젝트를 구성할 때 그 구성요소를 세가지의 역할로 구분한 패턴이다.
//	
//컨트롤러 : 데이터와 사용자 인터페이스 요소들을 잇는, 즉 ) 모델과 뷰를 이어주는 다리역할을 한다.
//	- 이벤트에 대해서 적당한 모델을 선택한다. 로직은 컨트롤러가 담당한다.
//*/
//
//public class Ex2_MVC컨트롤러 {
//	//Model의 객체 변수를 생성한다.
//	MovieModel model = new MovieModel();
//	
//	//리스트에 영화 제목을 추가하는 메서드
//	public void addTitle(String title, List MoiveList) {
//		try {
//			//모델 객체에 addTitle 메서드 실행
//			model.addTitle(title, MoiveList);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//	}
